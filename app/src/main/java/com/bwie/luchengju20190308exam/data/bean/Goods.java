package com.bwie.luchengju20190308exam.data.bean;
...
public class Goods {
    ...
    public static class DataBean {
        ...
        public boolean getBusinessChecked(boolean checked) {
